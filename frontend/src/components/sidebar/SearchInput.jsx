...
const SearchInput = () => {
  ...
  return (
    <form className="flex w-full justify-between items-center gap-2 mt-2" onSubmit={handleSubmit}> 
        <input type="text" placeholder="Search..." className="input w-full p-3 input-bordered rounded-full bg-black" 
        value={search}
