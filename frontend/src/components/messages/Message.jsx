import { extractTime } from "../../../utls/extractTime";
...
//             </div>
//         </div>
//         <div className={`chat-bubble text-white bg-blue-500`}>Hii What is App</div>
//         <div className={`chat-fotter opacity-50 text-xl flex gap-1 items-center`}>12:12</div>
//     </div>
//   )
// }
